...
$path_repo_unreal           = join-path $path_repo         'unreal_engine'
...
$path_refactor              = join-path $PSScriptRoot      'helpers/refactor.exe'
Push-Location $path_gencpp_scripts
	...
	Copy-Item -Path $path_refactor          -Destination $path_repo_refactor
